...
1. java -jar .assembly/health-balance-mac-0.20.jar
2. java -jar .assembly/health-balance-m1-0.20.jar
3. java -jar .assembly/health-balance-win-0.20.jar
4. java -jar .assembly/health-balance-linux-0.20.jar
