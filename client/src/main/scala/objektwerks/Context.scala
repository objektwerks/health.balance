...
final class Context(config: Config):
  ...
  val labelStartDate = config.getString("label.startDate")
  val labelStartTime = config.getString("label.startTime")
  val labelFinishDate = config.getString("label.finishDate")
  val labelFinishTime = config.getString("label.finishTime")
